 ...
 */
define('URL', 'http://my.werkphlo.com/');
define('marketingURL', 'http://www.werkphlo.com/');
...
define('FACEBOOK_LOGIN_PATH', 'signin/loginWithFacebook');
define('FACEBOOK_REGISTER_PATH', 'signin/registerWithFacebook');
...
define('COOKIE_DOMAIN', '.werkphlo.com');
...
define('DB_TYPE', 'mysql');
define('DB_HOST', 'mysql8.namesco.net'); //http://www.mydbadmin.co.uk/?server=8
define('DB_NAME', 'SCN03623_wp');
define('DB_USER', 'werkphlo');
define('DB_PASS', 'demo4James');
...
// name of your host
define("EMAIL_SMTP_HOST", 'smtp.hosts.co.uk');
// leave this true until your SMTP can be used without login
define("EMAIL_SMTP_AUTH", true);
// SMTP provider username
define("EMAIL_SMTP_USERNAME", 'account@werkphlo.com');
 ...
 */
define("EMAIL_PASSWORD_RESET_URL", URL . "signin/verifypasswordreset");
define("EMAIL_PASSWORD_RESET_FROM_EMAIL", "no-reply@werkphlo.com");
define("EMAIL_VERIFICATION_URL", URL . "register/verify");
define("EMAIL_VERIFICATION_FROM_EMAIL", "no-reply@werkphlo.com");

// language files currently only UK
include_once("lang/en-gb.php");